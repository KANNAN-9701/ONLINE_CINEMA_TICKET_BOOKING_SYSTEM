    ...
    <a href='contact_us.jsp'><img src="images/contact.gif"></a>
        ...
        <br>
            ...
            if(con!=null){
                 ...
                 int i =stmt.executeUpdate("insert into showdetails(theatreid,movieid,timeslot,priceperseat,seatavailable)values('"+theatreid+"','"+movieid+"','"+timeslot+"','"+priceperseat+"','"+seatavailable+"')");        
               
                 %>
                 <center>
            <h3> Show Details Added.</h3>
            <br><br>
                 <h3><a href='AddNewShow.jsp'>Click Here To Add Another Show</a></h3>
           <% }
           if(con==null)
           {con.close();}
            }
